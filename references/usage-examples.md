...
```json
{
  "raw_input": "/写解决方案 客户是某零售连锁企业，项目是门店运营体系年度升级。当前存在服务质量波动、客户投诉偏多、门店忙闲不均、现场管理动作不统一等问题。希望在合规前提下，围绕客户满意度提升、投诉率下降、人员配置优化、服务标准统一、弹性用工机制、投入产出提升，形成一套可落地的年度运营优化方案。请结合当地门店布局、客群特点、监管要求、同业实践、经营压力和现有团队基础，输出一份正式解决方案。",
  "output_docx": "",
